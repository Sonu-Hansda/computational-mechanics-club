  ...
  return (
    <footer className="bg-gray-100">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex justify-center text-teal-600 font-semibold text-2xl">
          Computational Mechanics Club
        </div>
        ...
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          ...
          <li>
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="size-6" fill="currentColor" aria-hidden="true" viewBox="0 0 50  50">
